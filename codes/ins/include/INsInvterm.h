...
public:
	...
	Real vnrel,timestep, res_u, res_v, res_w, res_p, maxu, maxv, maxw,c2d,Fn1,Fn2,Fn3, lfdist, rfdist,ppd, vis, remax_V, remax_pp, remax_up, remax_vp, remax_wp;  // l2rdx, l2rdy, l2rdz,
    Real cl, cr, cm;
public:
